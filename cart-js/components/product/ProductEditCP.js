        ...
        <form action={putAction} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              defaultValue={pno}
              readOnly
              className="mt-1 block w-full rounded-md text-blue-500 border-gray-300 shadow-sm bg-gray-100 cursor-not-allowed"
            />
          </div>
          {/* 상품명 입력 필드 */}
          <div>
            ...
            <input
              ...
              name="pname"
              defaultValue={pname}
              className="mt-1 block w-full rounded-md text-gray-500 border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            />
          </div>
          {/* 가격 입력 필드 */}
          <div>
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none block w-full px-4 font-medium py-2 pr-8 border text-gray-500 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-lg bg-white transition duration-150 ease-in-out"
              >
